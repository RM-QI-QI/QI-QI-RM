...
void UI_Delete(char robot_id,int cilent_id,u8 Del_Operate,u8 Del_Layer);
...
int UI_ReFresh(char robot_id,int cilent_id,int cnt,...);
...
int Char_ReFresh(char robot_id,int cilent_id,String_Data string_Data);
