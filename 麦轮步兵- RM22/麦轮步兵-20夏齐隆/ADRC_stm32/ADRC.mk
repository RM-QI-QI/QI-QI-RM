...
MATLAB_ROOT          = "D:/mat"
ALT_MATLAB_ROOT      = "D:/mat"
MATLAB_BIN           = "D:/mat/bin"
ALT_MATLAB_BIN       = "D:/mat/bin"
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 3
BUILDARGS            =  GENERATE_ASAP2=0 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTID01EQ=1"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ADRC_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -IC:/Users/vkd/Desktop/TEST(1~1  -IC:/Users/vkd/Desktop/TEST(1~1/ADRC_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -ID:/stm32mat/STM32/addSrc/inc 
...
%.o: $(subst ",,D:/stm32mat/STM32/addSrc/src)/%.cpp
	@echo ### Source $< done
...
%.o: $(subst ",,D:/stm32mat/STM32/addSrc/src)/%$(SRC_FILE_EXT)
	@echo ### Source $< done
