...
void stm32_pid_init_pitch(void)  //pitch
{
	...
	stm32_U_pitch.P_D=40;   //50	 ; 
	stm32_U_pitch.P_N=35	;  //30
	stm32_U_pitch.S_P=120;  //280
	stm32_U_pitch.S_I=1;     //1
...
//void stm32_pid_init_pitch(void)  //pitch
//{
//	stm32_U_pitch.P_P=1100;//   1800;
//	stm32_U_pitch.P_I=1;  //1
//	stm32_U_pitch.P_D=50;   //50	 ; 
//	stm32_U_pitch.P_N=30	;  //30
//	stm32_U_pitch.S_P=110;  //280
//	stm32_U_pitch.S_I=1;     //1
//	stm32_U_pitch.S_D=3;    //3
//	stm32_U_pitch.S_N=20;  //20
//		
//}
//void stm32_pid_init_pitch(void)  //pitch
//{
//	stm32_U_pitch.P_P=1769.35185557561;//   1800;
//	stm32_U_pitch.P_I=1.02210944033;  //1
//	stm32_U_pitch.P_D=-43.8549738651635;   //50	 ; 
//	stm32_U_pitch.P_N=39.5064243372613	;  //30
//	stm32_U_pitch.S_P=103.480557704945;  //280
//	stm32_U_pitch.S_I=1.728147302473;     //1
//	stm32_U_pitch.S_D=-0.0581897866675695;    //3
//	stm32_U_pitch.S_N=1778.32852861476;  //20
//		
//}
